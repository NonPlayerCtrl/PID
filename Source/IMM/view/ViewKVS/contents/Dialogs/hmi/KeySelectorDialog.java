...
public class KeySelectorDialog {
   ...
   private static final String RESOURCE_BUNDLE = "Dialogs.hmi.text.KeySelectorDialogTx";
   ...
   private void createKeyEventFunctionality(int keyCode) {
      ...
      if (keyCode == KEY_CODE_CORE) {
                  ...
                  public void actionPerformed(ActionEvent e) {
                     ...
                     if (isDeviceReady) {
                        ...
                        try {
                           ...
                           hmiVarService.writeValue(kvarCoreSelector, new Integer(selectionCore + 1));
         ...
         if (!dialogAirValveIsOpen) {
                  ...
                  public void actionPerformed(ActionEvent e) {
                     ...
                     if (isDeviceReady) {
                        ...
                        try {
                           ...
                           hmiVarService.writeValue(kvarAirValveSelector, new Integer(selectionAirValve + 1));
            ...
            // Initialize the initial airValve
